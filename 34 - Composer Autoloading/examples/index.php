...
<main>
    <?php foreach ($blog->articles as $article) : ?>
        <article>
            ...
            <p><time datetime><?= $article->$date ?></time></p>
        </article>
    <?php endforeach; ?>
</main>